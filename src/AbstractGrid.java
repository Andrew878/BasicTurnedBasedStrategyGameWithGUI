...
abstract class AbstractGrid {
    ...
    /**
     * Display the grid to standard output Items need to override their toString
     * methods to work well with this method. Notice: this method assumes fairly
     * short toString methods (up to 14 chars).
     *
     */
    public void display() {
        int columnWidth = 14;
    ...
    /**
     * Center a string by prepending and appending space characters to either
     * side.
     *
